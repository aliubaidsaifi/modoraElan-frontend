...
export const userAuth = {
  ...
  // 👇 Email OTP login + signup + forgot password
  sendOtp: (email, purpose = "login") => authReq("/auth/otp/send", { email, purpose }),
  verifyOtp: (email, code) => authReq("/auth/otp/verify", { email, code }),
  resetPassword: (email, code, password) => authReq("/auth/reset", { email, code, password }),
